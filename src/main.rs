...
fn pow5<E: Engine, CS: ConstraintSystem<E>>(mut cs: CS, x_val: &Option<E::Fr>, x: &Variable) -> Result<(Option<E::Fr>, Variable), SynthesisError> {
...
impl <E: Engine> Circuit<E> for InvPow5<E> {
	fn synthesize<CS: ConstraintSystem<E>>(self, cs: &mut CS) -> Result<(), SynthesisError> {
		...
		let (x_5_val, x_5) = pow5(cs.namespace(|| "pow5"), &x_val, &x)?;
